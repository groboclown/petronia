...
if [ "${use_client}" = 0 ] ; then
  ...
  python3 projects/native-handler/petronia_native_x11/libs/xcb_library/new_win_cli.py
elif [ "${use_client}" = 2 ] ; then
  python3 projects/native-handler/petronia_native_x11/libs/simplest_wm_cli.py
fi
