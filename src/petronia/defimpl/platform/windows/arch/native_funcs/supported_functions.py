...
from ......core.platform.api import Color
...
class WindowFunctions:
    ...
    find_handle_for_child_class_title: Optional[Callable[[HWND, Optional[HWND], str, str], Optional[HWND]]]
    ...
    send_message: Optional[Callable[[HWND, UINT, WPARAM, LPARAM], Union[WindowsErrorMessage, LPARAM]]]
    ...
    create_message_window: Optional[Callable[[str, NativeMessageCallback], Union[HWND, WindowsErrorMessage]]]
    ...
    set_style: Optional[Callable[[HWND, Dict[str, bool]], Union[WindowsErrorMessage, Dict[str, bool]]]]
...
class ShellFunctions:
    ...
    shell_hook: Optional[Callable[[Callable[[int, WPARAM, LPARAM], Optional[str]]], Union[HHOOK, WindowsErrorMessage]]]
    ...
    create_global_message_handler: Optional[Callable[[Dict[int, MessageCallback]], NativeMessageCallback]]
...
class ProcessFunctions:
    ...
    get_username_domain_for_pid: Optional[Callable[[DWORD], Union[Tuple[str, str], WindowsErrorMessage]]]
    get_current_username_domain: Optional[Callable[[], Union[Tuple[str, str], WindowsErrorMessage]]]
    ...
    get_all_service_information: Optional[Callable[[], Union[WindowsErrorMessage, Sequence[ProcessMetrics]]]]
