...
class ExtensionLoadedEvent:
    ...
    """
    __slots__ = ('_extension_name', '_loaded_dependencies')

    def __init__(self, extension_name: str, loaded_dependencies: Sequence[str]) -> None:
        self._extension_name = extension_name
        self._loaded_dependencies = tuple(loaded_dependencies)
