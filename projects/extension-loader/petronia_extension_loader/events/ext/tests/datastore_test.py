...
STORE_DATA_REQUEST_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'json': 'ӛ!ӻѻϨƵėԈқҺǀѡє\x82˩ƾËŋǓʰĕЎȘǶ\x87ǨԃʀΚӿ',
        },
    ),
    (
...
SEND_STATE_REQUEST_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'store_id': 'ӆʜӅɴǀҹҋΐЄǚԗŉɠΔǦƝɡѺΖ˃ѐ)ѽËʠɰ\x87˧ŶѦ',
        },
    ),
    (
        'bare-minimum-fields-present',
...
DATA_UPDATED_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'changed': '20220522:172820.364108:+0000',
            'json': 'χƠ˫ʀԂӳξϥɀȶƿІ˥í˖VöǮ\xadѳΡ;ǰȇϗñѶѮӟÍ',
        },
    ),
    (
        'bare-minimum-fields-present',
        {
            ...
            'changed': '20220522:172820.370185:+0000',
