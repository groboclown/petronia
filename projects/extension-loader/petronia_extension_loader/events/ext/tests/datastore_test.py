...
STORE_DATA_REQUEST_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'json': 'ѡƤȿҨЈŤʯδԢƯʜɛIȫЋàҊē\xadΡ÷ªƘȐɭтˈ\u038bˁË',
        },
    ),
    (
...
SEND_STATE_REQUEST_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'store_id': 'ǟȎЭЊƦȴιѻԦĉоñjԅԃО\x85ʍ\x8dԣȃ\x91®ѡz\x80)ͲɅí',
        },
    ),
    (
        'bare-minimum-fields-present',
...
DATA_UPDATED_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'changed': '20220526:211057.949924:+0000',
            'json': 'ťаѲū2\x7fōΜ˵ВĢӒҮǌφԮɧţ5҃ƢdZԦПʋѕ\x94ǌǚ',
        },
    ),
    (
        'bare-minimum-fields-present',
        {
            ...
            'changed': '20220526:211057.972702:+0000',
