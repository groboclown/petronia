...
STORE_DATA_REQUEST_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'json': 'шbÎϛ·\x9b£ϦXԮûΡśԘƮ{Ӑ˜Ӝȏɯ,¦ΉӐʚҼԌőʥ',
        },
    ),
    (
...
SEND_STATE_REQUEST_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'store_id': 'ЍҠ2ύϟѽΥĜvЇǴ\x84Ńɘ˾˂ŃΫZùnԑɗʑŠĜÆĨԐ˺',
        },
    ),
    (
        'bare-minimum-fields-present',
...
DATA_UPDATED_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'changed': '20220523:220032.228124:+0000',
            'json': '˓ҫԍˡԪЧρĩԋΈΙĞδӔͷſΣМç\x82ҷҿɠΕАʫЕϓѲƹ',
        },
    ),
    (
        'bare-minimum-fields-present',
        {
            ...
            'changed': '20220523:220032.228272:+0000',
