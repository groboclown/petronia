...
STORE_DATA_REQUEST_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'json': 'Ͼ4ʀ˻˙ȜюМШɺЗ¤ӍW;ʣ\x95ȿѢ\x8cːγҧδȲѝҴɨʄĚ',
        },
    ),
    (
...
SEND_STATE_REQUEST_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'store_id': 'ˋΑMŕϡϑɣ\x94ŁȵȎɜɚǣıĔϪǹǅӼԐϲǮŔř˪ԓåыƟ',
        },
    ),
    (
        'bare-minimum-fields-present',
...
DATA_UPDATED_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'changed': '20211104:182057.750110:+0000',
            'json': 'ˢʝǗрѳǴϕĚҙǈňԢŪ˗ÌÒ¯ŜǟӶʱbśzʰRӦƖ˥ʛ',
        },
    ),
    (
        'bare-minimum-fields-present',
        {
            ...
            'changed': '20211104:182057.770107:+0000',
