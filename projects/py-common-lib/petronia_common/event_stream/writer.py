...
from . import consts
from .defs import RawBinaryReader
...
# Construct a binary mapping, to make the transmission faster...
# This is a bad limitation to the python bytes stuff.
