...
import unittest
import json
from .shared import CallbackCollector, PACKET_MARKER, as_bin_str, create_read_stream
from .. import reader
from .. import consts
from ..defs import (
...
class ParseRawEventTest(unittest.TestCase):
    ...
    def test_data(self) -> None:
        ...
        for test_name, byte_data, expected, left_over in PARSE_DATA:
    ...
    def test_get_empty_reader(self) -> None:
        ...
        self.assertEqual(b'12', stream.marked_read(10))
    ...
    def test_get_static_reader(self) -> None:
        ...
        self.assertEqual(b'3', stream.marked_read(10))
