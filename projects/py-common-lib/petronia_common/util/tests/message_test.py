...
class MessageTest(unittest.TestCase):
    ...
    def test_debug(self) -> None:
        ...
        msg = message.UserMessage('x', message.i18n('4: {a} {b} {c}'), a="1", b=["x"], c=True)
        self.assertEqual("4: 1 ['x'] True", msg.debug())

    def test_equal(self) -> None:
        """Equality check."""
        msg1 = message.UserMessage('x', message.i18n('5: {a} {b} {c}'), a="1", b=["x"], c=True)
        msg2 = message.UserMessage('x', message.i18n('5: {a} {b} {c}'), b=["x"], c=True, a="1")
        self.assertTrue(msg1 == msg2)
        self.assertTrue(msg2 == msg1)

    def test_not_equal(self) -> None:
        """Not equal check."""
        msg1 = message.UserMessage('a', message.i18n('6: {a} {b} {c}'), a="1", b=["x"], c=True)
        msg2 = message.UserMessage('a', message.i18n('6: {a} {b} {c}'), b=["x"], c=False, a="1")
        msg3 = message.UserMessage('a', message.i18n('6: {a} {b} {c}'), b=["y"], c=True, a="1")
        msg4 = message.UserMessage('a', message.i18n('6: {a} {b} {c}'), a="1")
        msg5 = message.UserMessage('a', message.i18n('6: oh yeah'))
        msg6 = message.UserMessage('b', message.i18n('6: {a} {b} {c}'), a="1", b=["x"], c=True)
        msg1_b = message.UserMessage('a', message.i18n('6: {a} {b} {c}'), a="1", b=["x"], c=True)
        ...
        self.assertTrue(msg1 != msg6)

    def test_hash(self) -> None:
        """hash check"""
        msg1 = message.UserMessage('x', message.i18n('5: {a} {b} {c}'), a="1", b=["x"], c=True)
        msg2 = message.UserMessage('x', message.i18n('5: {a} {b} {c}'), b=["x"], c=True, a="1")
        msg3 = message.UserMessage('x', message.i18n('6: {a} {b} {c}'), b=["y"], c=True, a="1")
        msg4 = message.UserMessage('y', message.i18n('5: {a} {b} {c}'), a="1", b=["x"], c=True)

        self.assertEqual(hash(msg1), hash(msg2))
        self.assertEqual(hash(msg1), hash(msg1))
        self.assertNotEqual(hash(msg1), hash(msg3))
        self.assertNotEqual(hash(msg1), hash(msg4))
