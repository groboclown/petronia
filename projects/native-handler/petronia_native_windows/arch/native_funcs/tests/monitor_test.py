...
class WindowsMonitorTest(unittest.TestCase):
    ...
    def test_scale_factor__mod_100(self) -> None:
        """Test the basic construction."""
        mtr = monitor.WindowsMonitor(
            monitor_handle=cast(HMONITOR, 1),
            monitor_index=0, monitor_left=2, monitor_right=32,
            monitor_top=3, monitor_bottom=43, work_left=10, work_right=50,
            work_top=100, work_bottom=122, name='m1', is_primary=False,
            dpi_x=96, dpi_y=97,
            scale_factor=200,
        )
        self.assertEqual(
    ...
    def test_are_monitors_different(self) -> None:
        ...
        mtr1a = monitor.WindowsMonitor(
            ...
            monitor_index=0, monitor_left=2, monitor_right=32,
            monitor_top=3, monitor_bottom=43, work_left=10, work_right=50,
            work_top=100, work_bottom=122, name='m1a', is_primary=False,
            dpi_x=96, dpi_y=97,
            scale_factor=150,
        )
        mtr1b = monitor.WindowsMonitor(
            monitor_handle=cast(HMONITOR, 2),
            monitor_index=1, monitor_left=2, monitor_right=32,
            monitor_top=3, monitor_bottom=43, work_left=10, work_right=50,
            work_top=100, work_bottom=122, name='m1b', is_primary=False,
            dpi_x=96, dpi_y=97,
            scale_factor=150,
        )
        mtr2a = monitor.WindowsMonitor(
            monitor_handle=cast(HMONITOR, 3),
            monitor_index=2, monitor_left=2000, monitor_right=32000,
            monitor_top=3000, monitor_bottom=43000, work_left=10000, work_right=50000,
            work_top=100000, work_bottom=122000, name='m2a', is_primary=False,
            dpi_x=96, dpi_y=97,
            scale_factor=150,
        )
        mtr2b = monitor.WindowsMonitor(
            monitor_handle=cast(HMONITOR, 4),
            monitor_index=2, monitor_left=2000, monitor_right=32000,
            monitor_top=3000, monitor_bottom=43000, work_left=10000, work_right=50000,
            work_top=100000, work_bottom=122000, name='m2b', is_primary=False,
            dpi_x=96, dpi_y=97,
            scale_factor=150,
        )
        self.assertFalse(
