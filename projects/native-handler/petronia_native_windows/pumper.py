...
This is being reworked.  The new code is put into message_loop.
"""
...
class WindowsHookPumper:
    ...
    def start(self, on_exit: Callable[[], None]) -> None:  # pylint:disable=too-many-statements
        ...
        def message_pumper() -> None:  # pylint:disable=too-many-branches
            ...
            if WINDOWS_FUNCTIONS.shell.shell_hook:
                ...
                if isinstance(hook, WindowsErrorMessage):
                    ...
                    # x86 and x64 version.
                    # https://stackoverflow.com/questions/61413733/
