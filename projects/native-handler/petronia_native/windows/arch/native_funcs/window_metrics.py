...
class FontMetrics:  # pylint:disable=too-many-instance-attributes
    """Usable structure for information about fonts."""
    __slots__ = (
        'height',
        'width',
        'escapement',
...
class WindowMetrics:  # pylint:disable=too-many-instance-attributes
    """
