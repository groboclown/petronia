...
"""
Data structures and marshalling for extension petronia.core.api.native.l10n version 1.0.0.
"""
...
EXTENSION_NAME = 'petronia.core.api.native.l10n'
...
class RegisterTranslationEvent:
    ...
    FULL_EVENT_NAME = 'petronia.core.api.native.l10n:register-translation'
...
class RegisterTranslationSuccessEvent:
    ...
    """
    __slots__ = ()
    FULL_EVENT_NAME = 'petronia.core.api.native.l10n:register-translation:success'
...
class RegisterTranslationFailedEvent:
    ...
    """
    __slots__ = ('error',)
    FULL_EVENT_NAME = 'petronia.core.api.native.l10n:register-translation:failed'
...
class RegisterTranslationMessagesEvent:
    ...
    """
    __slots__ = ()
    FULL_EVENT_NAME = 'petronia.core.api.native.l10n:register-translation:messages'
...
class SetLocaleEvent:
    ...
    FULL_EVENT_NAME = 'petronia.core.api.native.l10n:set-locale'
...
class TranslationsState:
    ...
    UNIQUE_TARGET_FQN = 'petronia.core.api.native.l10n:translations'
    UNIQUE_TARGET_REL = 'petronia.core.api.native.l10n:translations'
...
class LocalesState:
    ...
    UNIQUE_TARGET_FQN = 'petronia.core.api.native.l10n:locales'
    UNIQUE_TARGET_REL = 'petronia.core.api.native.l10n:locales'
...
class ActiveLocaleState:
    ...
    UNIQUE_TARGET_FQN = 'petronia.core.api.native.l10n:active-locale'
    UNIQUE_TARGET_REL = 'petronia.core.api.native.l10n:active-locale'
