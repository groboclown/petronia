...
STORE_DATA_REQUEST_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'json': 'ñǮȣΥ+όŕҋưɔΆǂ˟ѲйĻĚɚźǦǺ¤ƌoơжƭɆ˰ώ',
        },
    ),
    (
...
SEND_STATE_REQUEST_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'store_id': '\\ӇѭвɹўҒνʼѤʊ˒ѺҳϙŎāǺɀȽλʫӏ3ɺʄϜ\x990±',
        },
    ),
    (
        'bare-minimum-fields-present',
...
DATA_UPDATED_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'changed': '20220526:212244.094119:+0000',
            'json': '\x90»гȴЗѯǛțΙίŏˢİɨђԀȉАğӤȶњԭ˷GϯʏɀǛҬ',
        },
    ),
    (
        'bare-minimum-fields-present',
        {
            ...
            'changed': '20220526:212244.112340:+0000',
