...
STORE_DATA_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'json': 'ϛӋҎȌҏӏ×όʘΕʒyӘkΉǫˎƖ˶ïν˷њČѰР\x99ʈѷ\x9c',
        },
    ),
    (
...
SEND_STATE_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'store_id': '-<ѕϥ©λ£Ɛвϳ\x8fȗʑԭŬǚʳšʽϹ˵ŽԙˋǘЮМȦȏҢ',
        },
    ),
    (
        'bare-minimum-fields-present',
...
DATA_UPDATE_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'changed': '20210327:032328.286069:+0000',
            'json': 'ʥӤ³˕Ϋ\x7fΆúϸưĆİѴ˗ɣΊіıŃɴɡӦŀҴΏq˾μӈН',
        },
    ),
    (
        'bare-minimum-fields-present',
        {
            ...
            'changed': '20210327:032328.305875:+0000',
