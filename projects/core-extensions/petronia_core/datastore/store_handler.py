...
from petronia_ext_lib.runner import EventRegistryContext, ContextEventObjectTarget, EventBinaryTarget
    ...
    return join_none_results(
        send_register_listeners(
            ...
            (
                ...
                (datastore_event.StoreBinaryRequestEvent.FULL_EVENT_NAME, None),
            ),
        ),
        ...
        # datastore_event.StoreBinaryRequestEvent is binary, so no parser to register.
        context.register_binary_target(
            datastore_event.StoreBinaryRequestEvent.FULL_EVENT_NAME,
            None,
            StoreBinaryDataHandler(context),
        )
    )
...
class StoreBinaryDataHandler(EventBinaryTarget):
    """Handles the store binary data requests."""
