...
STORE_DATA_REQUEST_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'json': 'ϽŭɖƝʜƊɣǟҵϗʌǄ¾ʨЅɍ\x9d҅ӕиƔǚ˕\x90"ΕȇɃãĖ',
        },
    ),
    (
...
SEND_STATE_REQUEST_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'store_id': "ʥΠŢиӣ\u0379ԁž'´ͳʤн\x971\u0383Ąı\x9cԫӯ¾¾Ǆ×ҽÙӚѿç",
        },
    ),
    (
        'bare-minimum-fields-present',
...
DATA_UPDATED_EVENT_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'changed': '20220522:172822.108080:+0000',
            'json': 'Ɓϫʧ҄ԐҮcѶĤƍ\x8fӶԎкʪƜӜǿǞʙϖŢÔӽʼХӍʾӤ˳',
        },
    ),
    (
        'bare-minimum-fields-present',
        {
            ...
            'changed': '20220522:172822.117060:+0000',
