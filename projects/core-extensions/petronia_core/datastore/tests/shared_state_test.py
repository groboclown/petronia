...
class SharedStateTest(unittest.TestCase):
    ...
    def test_get_store_data(self) -> None:
        ...
        time.sleep(0.1)
        upd2b, when2b = shared_state.store_data('d2', 'v2')
