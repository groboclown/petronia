...
Extension petronia_core.binarystore, Version 1.0.0
"""
    ...
    def test_parse_bad_data(self) -> None:
        ...
        for test_name, test_data, messages in CONFIGURATION_STATE_BAD_PARSE_DATA_TESTS:
            with self.subTest(name=test_name):
                res = binarystore.ConfigurationState.parse_data(test_data)
...
CONFIGURATION_STATE_GOOD_PARSE_DATA_TESTS: Sequence[
    ...
    (
        'all-fields-present',
        {
            'cachedir': 'ҧɥ\x99чΫİŵ˞ǜ!ΚØƗǆѤǫŌ\x9cЋ\xadԕ˳ц2ʀɿáБ²ҥ',
            'request_timeout_seconds': 154323.60807678776,
        },
    ),
    (
